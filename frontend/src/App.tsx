  ...
  return (
    ...
    >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col items-center justify-center relative z-10">
        ...
        <section id="hero" className="relative pt-4 pb-10 text-center flex flex-col items-center justify-center space-y-8">
          ...
          <div className="relative cursor-pointer animate-fade-in">
            <img 
              src="/kettli-logo.png" 
              alt="kettli Logo" 
              className="h-48 sm:h-64 md:h-80 w-auto object-contain hover:scale-105 transition-transform duration-300 drop-shadow-[0_10px_25px_rgba(0,0,0,0.7)]"
            />
          </div>
